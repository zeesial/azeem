...
def m1(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua = 'Dalvik/2.1.0 (Linux; U; Android 10.0.0; RMX2027 Build/8BFOHT) [FBAN/FB4A;FBAV/92.866.944.616;FBPN/com.facebook.katana;FBLC/en_US;FBBV/322216925;FBCR/null;FBMF/Realme C2;FBBD/Realme C2;FBDV/Realme C2;FBSV/Realme C2.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.25,width=720,height=1280};]'
